...
def program_1():
    ...
    print('\n')
    print("\033[32;4m*******Feeder and BOM data Verification Version--PY_V-2.2 interface_GUI/F0524-89P13*******\033[0m")
...
def program_3():
    ...
    print('\n')
    print("\033[32;4m*******Feeder and BOM data Verification Version--PY_V-2.2-X interface_GUI/F0524-89P13*******\033[0m")
...
print("\n")
print("1. FeederSetup: V-2.2") #89P13
print("2. BOM Manipulation: V-1.2") #89P13
print("3. FeederSetup: V-2.2-X") #89P13
