...
# Program A: FeederSetup
def program_A():

    print('\n')
    print("\033[32;4m*******Feeder and BOM data Verification Version--PY_V-2.4 interface_GUI/M1124-89P13*******\033[0m")
...
##########################################################################################################################################
    ...
    '''if os.path.exists("Feeder_List_OPT.xlsx Feeder_List_OPB.xlsx"):
    ...
    #CREATEBACKUPFOLDER
        ...
        os.getcwd()
        Chd= os.chdir('D:/NX_BACKWORK/Feeder Setup_PROCESS/#Output/FeederSetup') #Upload
        Chd = os.getcwd()
        ...
        ##########################################################################################################################################
        #from ProgramE import program_E #Inspect AVL and NPI Feeder List
        ##########################################################################################################################################
